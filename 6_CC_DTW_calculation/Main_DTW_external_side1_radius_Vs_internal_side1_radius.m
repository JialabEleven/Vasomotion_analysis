...
buildingDir = fullfile([cur_p '6_CC_DTW_calculation\external_radius_Vs_internal_radius\external_side1_radius_Vs_internal_side1_radius.xls']);
savepath = fullfile([cur_p '6_CC_DTW_calculation\external_radius_Vs_internal_radius\']);
